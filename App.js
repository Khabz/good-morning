      ...
      <Fragment>
        ...
        <View style={{ flex: 1, backgroundColor: "black" }}>
          <SafeAreaView style={{ backgroundColor: "black" }}>
            <Animated.Text style={[styles.headerText, { left: headerTextPositionLeft, top: headerTextPositionTop, opacity: headerTextOpacity }]}>Good morning Ndivhuwo</Animated.Text>
          </SafeAreaView>
          <View style={{ flex: 1 }}>
